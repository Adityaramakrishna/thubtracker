          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li><Link to="/dashboard">{props.t("Dashboard")} </Link></li>
           ...
           {/* <li>  
            ...
            <li>
              ...
              <ul className="sub-menu">
                ...
                {/* <li>
                  <Link to="/form-advanced">{props.t("Description Data")}</Link>
                </li> */}
                {/* <li>
            ...
            <li>
              ...
              <ul className="sub-menu">
                ...
                {/* <li>
                  <Link to="/tables-datatable">{props.t("Project data")}</Link>
                </li> */}
                {/* <li>
                ...
                <li>
                    <Link to="/tables-datatable">{props.t("Projects List")}</Link>
                  </li>
            ...
            <li>
                  <Link to="/#" className="has-arrow waves-effect">
                    <i className="mdi mdi-clipboard-list-outline"></i>
                    <span>{props.t("Work TrackingSheet")}</span>
                  </Link>
                  <ul className="sub-menu">
                  <li>
                  <Link to="/tables-editable">{props.t("Tracking Sheets")}</Link>
                </li>
            ...
            <li>
              ...
              <ul className="sub-menu">
                ...
                <li>
                  <Link to="/e-charts">{props.t("Exploded Charts")}</Link>
                </li>
                {/* <li>
